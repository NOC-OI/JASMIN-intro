...
[you@laptop:~]$ scp mpi4py.tar.gz jdoe@login.jasmin.ac.uk:
# or
[you@laptop:~]$ rsync -avP mpi4py.tar.gz jdoe@login.jasmin.ac.uk:
```
...
After logging back in to login.jasmin.ac.uk, `which` should be able to
