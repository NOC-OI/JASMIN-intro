...
```bash
[you@laptop:~]$ scp local_file jdoe@login.jasmin.ac.uk:remote_destination
```
...
```bash
[you@laptop:~]$ scp amdahl.tar.gz jdoe@login.jasmin.ac.uk:
```

:::::::::::::::::::::::::::::::::::::::  challenge

## Why Not Download on JASMIN Directly?
...
```bash
[you@laptop:~]$ scp -r amdahl jdoe@login.jasmin.ac.uk:
```
...
```bash
[you@laptop:~]$ rsync -avP amdahl.tar.gz jdoe@login.jasmin.ac.uk:
```
...
```bash
[you@laptop:~]$ rsync -avP amdahl jdoe@login.jasmin.ac.uk:~/
```
...
```bash
[you@laptop:~]$ rsync -avP jdoe@login.jasmin.ac.uk:amdahl ./
```
...
```bash
[you@laptop:~]$ rsync amdahl.tar.gz jdoe@login.jasmin.ac.uk:
```
...
[you@laptop:~]$ rsync --port=768 amdahl.tar.gz jdoe@login.jasmin.ac.uk:
```
